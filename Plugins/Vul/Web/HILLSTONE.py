...
class Detect(threading.Thread):
    ...
    def check(self, url):
        ico_url = url + '/resources/images/login/logo_login.svg'
        m1 = hashlib.md5()
        try:
            ...
            # print(the_md5)
            if the_md5 == 'c24c187b83eead4d76e81d770f70bc5c':
                tqdm.write(Fore.RED + '[{}] {}'.format('HILLSTONE', url))
                self.vul_list.append(['HILLSTONE', url, 'Maybe HILLSTONE/HILLSTONE'])
                return True
            else:
                return False
